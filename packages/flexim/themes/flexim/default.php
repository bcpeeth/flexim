...
<section class="intro padding--top-3-steps padding--bottom-3-steps">
  <div class="grid__container grid__visual">
...
<section class="target">
  <div class="grid__container padding--top-2-steps padding--bottom-2-steps grid__visual">
    
    <div class="grid__col--12 grid__collapse">
