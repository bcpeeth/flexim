...
<section class="hero">
    <img class="top" src="<?php echo $view->getThemePath(); ?>/assets/images/teamwork.jpg">
</section>
...
<section class="nieuws">
        ...
        <div class="grid__container padding--top-2-steps padding--bottom-2-steps">
            ...
            <div class="grid__col--6 grid__col--sm-12">
                <div class="nieuws-block-text nieuws-block-text--left">
                    <h4 class="padding--bottom-half-step">Tour de Flexim brengt € 12.122,- op!</h4>
            ...
            <div class="grid__col--6 grid__col--sm-12">
                <div class="nieuws-block-image nieuws-block__image--right">
                    <iframe width="461" height="308" src="https://www.youtube.com/embed/NtKh9aSO6xk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    ...
    <div class="nieuws-block">
        <div class="grid__container padding--top-2-steps padding--bottom-2-steps">
            ...
            <div class="grid__col--6 grid__col--sm-12">
                <div class="nieuws-block-text nieuws-block-text--left">
                    <h4 class="padding--bottom-half-step">Flexim Foundation lanceert nieuwe website</h4>
                    <p>De afgelopen weken is er binnen de stichting hard gewerkt aan de oprichting van de Flexim Foundation. Hierbij kan een website niet ontbreken! Met behulp van diverse vrijwilligers is er een mooie website tot stand gekomen. Flexim Foundation is trots dat de marketing uitingen vorm beginnen te krijgen en zal de komende maanden steeds meer gaan communiceren om haar doelstelling te realiseren.
                    <br />
                    <br />
                    Wil jij meer weten over de Flexim Foundation en hoe je kan bijdragen, neem dan contact op via contact@fleximfoundation.com
                    </p>
                </div>
            </div>
